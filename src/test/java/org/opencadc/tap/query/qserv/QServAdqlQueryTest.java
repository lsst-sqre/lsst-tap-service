...
import org.opencadc.tap.query.qserv.QServAdqlQuery;

/**
 *
 * @author pdowler
 */
public class QServAdqlQueryTest 
{
    private static final Logger log = Logger.getLogger(QServAdqlQueryTest.class);
    ...
    public void testOrigConverters()
    {
        try
        {
            ...
            QServAdqlQuery q = new QServAdqlQuery();
            q.setJob(job);
