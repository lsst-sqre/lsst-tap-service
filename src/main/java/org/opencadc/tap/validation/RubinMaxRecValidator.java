...
package org.opencadc.tap.validation;
...
import org.opencadc.tap.config.TapConfig;
  ...
  * @author pdowler
  */
 public class RubinMaxRecValidator extends MaxRecValidator {
     private static final Logger LOGGER = Logger.getLogger(RubinMaxRecValidator.class);
     private static final Integer DEFAULT_LIMIT = 100000000;


     public RubinMaxRecValidator() {
         super();
         Integer limit = TapConfig.maxRec();
