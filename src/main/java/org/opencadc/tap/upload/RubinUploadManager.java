 ...
 * @author stvoutsin
 */
public class RubinUploadManager extends BasicUploadManager {

    private static final Logger log = Logger.getLogger(RubinUploadManager.class);
    private static final TAPLogger tapLog = new TAPLogger(RubinUploadManager.class);
     ...
     */
    public RubinUploadManager(UploadLimits uploadLimits) {
        super(uploadLimits);
