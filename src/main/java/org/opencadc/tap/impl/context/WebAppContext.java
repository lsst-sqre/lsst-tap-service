...
/**
 * Singleton class that holds the ServletContext and provides application-wide access to it
 */
public class WebAppContext {
     ...
     * @return The attribute value, or null if not found or ServletContext is not set
     */
