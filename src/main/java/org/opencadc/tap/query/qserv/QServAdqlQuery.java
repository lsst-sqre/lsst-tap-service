...
/**
 * ADQL query implementation for the QServ backend. Adds the QServ region
 * converter and supports additional {@code visible:backend} table-name mappings
...
public class QServAdqlQuery extends AbstractRubinAdqlQuery {
    ...
    protected SelectNavigator createRegionConverter() {
        return new QServRegionConverter(new ExpressionNavigator(), new ReferenceNavigator(),
