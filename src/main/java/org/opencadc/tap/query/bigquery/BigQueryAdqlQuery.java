package org.opencadc.tap.query.bigquery;
...
import org.opencadc.tap.query.bigquery.expression.BigQueryExpressionDeParser;
import org.opencadc.tap.query.bigquery.parser.BigQueryQuerySelectDeParser;
import org.opencadc.tap.query.bigquery.parser.converter.BigQueryRegionConverter;
...
public class BigQueryAdqlQuery extends AdqlQuery {
    ...
    protected void init() {
        ...
        String project = TapConfig.bigQueryProject();
        String dataset = TapConfig.bigQueryDataset();
        String schemaName = TapConfig.bigQuerySchema();
        ...
        TableNameConverter tnc = AbstractRubinAdqlQuery.newTapSchema11Converter();
