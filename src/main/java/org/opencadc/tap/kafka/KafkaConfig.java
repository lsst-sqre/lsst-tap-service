 ...
 * Handles both producer and consumer configurations
 * 
 */
public class KafkaConfig {
     ...
     */
    public KafkaConfig(String bootstrapServer, String queryTopic, String statusTopic) {
        this(bootstrapServer, queryTopic, statusTopic, null, null);
    }
    ...
    public KafkaConfig(String bootstrapServer, String queryTopic, String statusTopic,
        ...
        if (useSasl) {
            log.info("Kafka SASL authentication enabled with SCRAM-SHA-512, username: " + username);
        } else {
            log.info("Kafka SASL authentication disabled - no credentials provided");
        }
    }
    ...
    public Producer<String, String> createProducer() {
        log.info("Creating Kafka JSON producer...");
        ...
        log.info("Setting up producer with bootstrap servers: " + bootstrapServer);
        ...
        if (useSasl) {
            log.info("Setting up SASL authentication");
        ...
        log.info("Creating KafkaProducer instance");
    ...
    public Properties createConsumerProperties(String groupId) {
        log.info("Creating consumer properties for group ID: " + groupId);
        ...
        if (useSasl) {
            log.info("Setting up SASL authentication for consumer");
