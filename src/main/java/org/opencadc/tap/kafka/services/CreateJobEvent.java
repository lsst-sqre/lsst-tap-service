...
public class CreateJobEvent implements AutoCloseable {
    ...
    public String submitQuery(String query, String jobID, String resultDestination, ResultFormat resultFormat) 
        ...
        return submitQuery(query, jobID, resultDestination, resultFormat, null, null);
    }
     ...
     * @throws InterruptedException if the operation is interrupted
     */
    public String submitQuery(String query, String jobID, String resultDestination, ResultFormat resultFormat, String ownerID, String database) 
            throws ExecutionException, InterruptedException {
        ...
        try {
            ...
            ProducerRecord<String, String> record = 
                new ProducerRecord<>(queryTopic, jobID, jsonString);
