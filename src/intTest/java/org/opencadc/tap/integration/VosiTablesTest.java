...
public class VosiTablesTest
{
    ...
    public VosiTablesTest()
    {
        ...
        this.tablesURL = rc.getServiceURL(URI.create("ivo://cadc.nrc.ca/tap"), Standards.VOSI_TABLES, AuthMethod.ANON);
    ...
    public void testValidateTableDoc()
    {
        try
        {
            ...
            Assert.assertEquals("ALMA.ASA_TABLES", td.getTableName());
        }
        catch(Exception unexpected)
        {
            log.error("unexpected exception", unexpected);
